...
# 4️⃣ Enable Syntax Highlighting (If Installed)
if [[ -f /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]]; then
  source /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
fi

# 5️⃣ Enable Command Autosuggestions (If Installed)
...
alias dsa='code /media/yashsawant/Coding/DSA'
...
alias whatsapp='brave-browser --profile-directory="Profile 1" --app-id=hnpfjngllnobngcgfapefoaidbinmjnm'
...
# 8️⃣ Load Powerlevel10k (If Installed)
